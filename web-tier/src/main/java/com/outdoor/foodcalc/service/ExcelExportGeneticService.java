...
import com.outdoor.foodcalc.service.distributionGenetic.GeneticDistributionService;
...
@Service
public class ExcelExportGeneticService {

    private final FoodPlanDomainService foodPlanService;
    private final GeneticDistributionService engine;

    public ExcelExportGeneticService(FoodPlanDomainService foodPlanService, GeneticDistributionService engine) {
